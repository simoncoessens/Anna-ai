          ...
          <div className="flex-1 flex flex-col justify-center items-center p-8">
            <div className="max-w-xl w-full">
              ...
              <p className="text-2xl text-gray-700 mb-4">
                The EU AI Act follows a risk-based approach, meaning some
                systems are banned because they go against core Union values
                like human dignity, freedom, and fundamental rights. Prohibited
                AI systems include those using subliminal and exploitative
                techniques.
                <br />
                <br />
                For example, if your AI system exploits vulnerabilities of
                specific groups, manipulates decision-making beyond conscious
                awareness, or conducts social scoring, it may fall under these
                prohibited categories. Unsure if your system falls under this
                category? Ask ANNA to find out if it's prohibited under the AIA!
              </p>
            </div>
          </div>
